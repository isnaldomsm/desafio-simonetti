...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderfdb50 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializere86b3 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties620d7 = [
        
    ];

    public function getConnection()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getConnection', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getMetadataFactory', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getExpressionBuilder', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'beginTransaction', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->beginTransaction();
    }

    public function getCache()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getCache', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getCache();
    }

    public function transactional($func)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'transactional', array('func' => $func), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->transactional($func);
    }

    public function commit()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'commit', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->commit();
    }

    public function rollback()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'rollback', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getClassMetadata', array('className' => $className), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'createQuery', array('dql' => $dql), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'createNamedQuery', array('name' => $name), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'createQueryBuilder', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'flush', array('entity' => $entity), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'clear', array('entityName' => $entityName), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->clear($entityName);
    }

    public function close()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'close', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->close();
    }

    public function persist($entity)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'persist', array('entity' => $entity), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'remove', array('entity' => $entity), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'refresh', array('entity' => $entity), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'detach', array('entity' => $entity), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'merge', array('entity' => $entity), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getRepository', array('entityName' => $entityName), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'contains', array('entity' => $entity), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getEventManager', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getConfiguration', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'isOpen', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getUnitOfWork', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getProxyFactory', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'initializeObject', array('obj' => $obj), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'getFilters', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'isFiltersStateClean', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'hasFilters', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return $this->valueHolderfdb50->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializere86b3 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderfdb50) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderfdb50 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderfdb50->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, '__get', ['name' => $name], $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        if (isset(self::$publicProperties620d7[$name])) {
            return $this->valueHolderfdb50->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderfdb50;
    ...
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, '__set', array('name' => $name, 'value' => $value), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;
    ...
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, '__isset', array('name' => $name), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;
    ...
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, '__unset', array('name' => $name), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;
    ...
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, '__clone', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        $this->valueHolderfdb50 = clone $this->valueHolderfdb50;
    }

    public function __sleep()
    {
        $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, '__sleep', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;

        return array('valueHolderfdb50');
    }
    ...
    {
        $this->initializere86b3 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializere86b3;
    }

    public function initializeProxy() : bool
    {
        return $this->initializere86b3 && ($this->initializere86b3->__invoke($valueHolderfdb50, $this, 'initializeProxy', array(), $this->initializere86b3) || 1) && $this->valueHolderfdb50 = $valueHolderfdb50;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderfdb50;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderfdb50;
    }
