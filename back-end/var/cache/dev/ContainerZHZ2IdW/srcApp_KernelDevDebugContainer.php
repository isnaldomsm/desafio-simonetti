...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderad3b9 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializere9b4c = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesede50 = [
        
    ];

    public function getConnection()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getConnection', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getMetadataFactory', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getExpressionBuilder', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'beginTransaction', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->beginTransaction();
    }

    public function getCache()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getCache', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getCache();
    }

    public function transactional($func)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'transactional', array('func' => $func), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->transactional($func);
    }

    public function commit()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'commit', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->commit();
    }

    public function rollback()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'rollback', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getClassMetadata', array('className' => $className), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'createQuery', array('dql' => $dql), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'createNamedQuery', array('name' => $name), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'createQueryBuilder', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'flush', array('entity' => $entity), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'clear', array('entityName' => $entityName), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->clear($entityName);
    }

    public function close()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'close', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->close();
    }

    public function persist($entity)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'persist', array('entity' => $entity), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'remove', array('entity' => $entity), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'refresh', array('entity' => $entity), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'detach', array('entity' => $entity), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'merge', array('entity' => $entity), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getRepository', array('entityName' => $entityName), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'contains', array('entity' => $entity), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getEventManager', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getConfiguration', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'isOpen', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getUnitOfWork', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getProxyFactory', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'initializeObject', array('obj' => $obj), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'getFilters', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'isFiltersStateClean', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'hasFilters', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return $this->valueHolderad3b9->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializere9b4c = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderad3b9) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderad3b9 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderad3b9->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, '__get', ['name' => $name], $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        if (isset(self::$publicPropertiesede50[$name])) {
            return $this->valueHolderad3b9->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderad3b9;
    ...
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, '__set', array('name' => $name, 'value' => $value), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;
    ...
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, '__isset', array('name' => $name), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;
    ...
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, '__unset', array('name' => $name), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;
    ...
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, '__clone', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        $this->valueHolderad3b9 = clone $this->valueHolderad3b9;
    }

    public function __sleep()
    {
        $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, '__sleep', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;

        return array('valueHolderad3b9');
    }
    ...
    {
        $this->initializere9b4c = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializere9b4c;
    }

    public function initializeProxy() : bool
    {
        return $this->initializere9b4c && ($this->initializere9b4c->__invoke($valueHolderad3b9, $this, 'initializeProxy', array(), $this->initializere9b4c) || 1) && $this->valueHolderad3b9 = $valueHolderad3b9;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderad3b9;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderad3b9;
    }
