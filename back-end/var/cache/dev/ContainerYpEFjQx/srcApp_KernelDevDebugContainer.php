...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderb9623 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerbd0f8 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesf2992 = [
        
    ];

    public function getConnection()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getConnection', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getMetadataFactory', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getExpressionBuilder', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'beginTransaction', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getCache', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getCache();
    }

    public function transactional($func)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'transactional', array('func' => $func), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->transactional($func);
    }

    public function commit()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'commit', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->commit();
    }

    public function rollback()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'rollback', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getClassMetadata', array('className' => $className), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'createQuery', array('dql' => $dql), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'createNamedQuery', array('name' => $name), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'createQueryBuilder', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'flush', array('entity' => $entity), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'clear', array('entityName' => $entityName), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->clear($entityName);
    }

    public function close()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'close', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->close();
    }

    public function persist($entity)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'persist', array('entity' => $entity), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'remove', array('entity' => $entity), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'refresh', array('entity' => $entity), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'detach', array('entity' => $entity), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'merge', array('entity' => $entity), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getRepository', array('entityName' => $entityName), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'contains', array('entity' => $entity), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getEventManager', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getConfiguration', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'isOpen', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getUnitOfWork', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getProxyFactory', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'initializeObject', array('obj' => $obj), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'getFilters', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'isFiltersStateClean', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'hasFilters', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return $this->valueHolderb9623->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerbd0f8 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderb9623) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderb9623 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderb9623->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, '__get', ['name' => $name], $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        if (isset(self::$publicPropertiesf2992[$name])) {
            return $this->valueHolderb9623->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderb9623;
    ...
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;
    ...
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, '__isset', array('name' => $name), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;
    ...
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, '__unset', array('name' => $name), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;
    ...
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, '__clone', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        $this->valueHolderb9623 = clone $this->valueHolderb9623;
    }

    public function __sleep()
    {
        $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, '__sleep', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;

        return array('valueHolderb9623');
    }
    ...
    {
        $this->initializerbd0f8 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerbd0f8;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerbd0f8 && ($this->initializerbd0f8->__invoke($valueHolderb9623, $this, 'initializeProxy', array(), $this->initializerbd0f8) || 1) && $this->valueHolderb9623 = $valueHolderb9623;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderb9623;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderb9623;
    }
