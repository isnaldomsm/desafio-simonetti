...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder28f8f = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerbd859 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties50873 = [
        
    ];

    public function getConnection()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getConnection', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getMetadataFactory', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getExpressionBuilder', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'beginTransaction', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getCache', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getCache();
    }

    public function transactional($func)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'transactional', array('func' => $func), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->transactional($func);
    }

    public function commit()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'commit', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->commit();
    }

    public function rollback()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'rollback', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getClassMetadata', array('className' => $className), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'createQuery', array('dql' => $dql), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'createNamedQuery', array('name' => $name), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'createQueryBuilder', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'flush', array('entity' => $entity), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'clear', array('entityName' => $entityName), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->clear($entityName);
    }

    public function close()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'close', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->close();
    }

    public function persist($entity)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'persist', array('entity' => $entity), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'remove', array('entity' => $entity), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'refresh', array('entity' => $entity), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'detach', array('entity' => $entity), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'merge', array('entity' => $entity), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getRepository', array('entityName' => $entityName), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'contains', array('entity' => $entity), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getEventManager', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getConfiguration', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'isOpen', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getUnitOfWork', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getProxyFactory', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'initializeObject', array('obj' => $obj), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'getFilters', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'isFiltersStateClean', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'hasFilters', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return $this->valueHolder28f8f->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerbd859 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder28f8f) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder28f8f = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder28f8f->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, '__get', ['name' => $name], $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        if (isset(self::$publicProperties50873[$name])) {
            return $this->valueHolder28f8f->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder28f8f;
    ...
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;
    ...
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, '__isset', array('name' => $name), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;
    ...
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, '__unset', array('name' => $name), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;
    ...
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, '__clone', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        $this->valueHolder28f8f = clone $this->valueHolder28f8f;
    }

    public function __sleep()
    {
        $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, '__sleep', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;

        return array('valueHolder28f8f');
    }
    ...
    {
        $this->initializerbd859 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerbd859;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerbd859 && ($this->initializerbd859->__invoke($valueHolder28f8f, $this, 'initializeProxy', array(), $this->initializerbd859) || 1) && $this->valueHolder28f8f = $valueHolder28f8f;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder28f8f;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder28f8f;
    }
