...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder2861d = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerea52e = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa9c65 = [
        
    ];

    public function getConnection()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getConnection', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getMetadataFactory', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getExpressionBuilder', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'beginTransaction', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getCache', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getCache();
    }

    public function transactional($func)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'transactional', array('func' => $func), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->transactional($func);
    }

    public function commit()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'commit', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->commit();
    }

    public function rollback()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'rollback', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getClassMetadata', array('className' => $className), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'createQuery', array('dql' => $dql), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'createNamedQuery', array('name' => $name), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'createQueryBuilder', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'flush', array('entity' => $entity), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'clear', array('entityName' => $entityName), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->clear($entityName);
    }

    public function close()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'close', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->close();
    }

    public function persist($entity)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'persist', array('entity' => $entity), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'remove', array('entity' => $entity), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'refresh', array('entity' => $entity), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'detach', array('entity' => $entity), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'merge', array('entity' => $entity), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getRepository', array('entityName' => $entityName), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'contains', array('entity' => $entity), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getEventManager', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getConfiguration', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'isOpen', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getUnitOfWork', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getProxyFactory', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'initializeObject', array('obj' => $obj), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'getFilters', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'isFiltersStateClean', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'hasFilters', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return $this->valueHolder2861d->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerea52e = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder2861d) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder2861d = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder2861d->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, '__get', ['name' => $name], $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        if (isset(self::$publicPropertiesa9c65[$name])) {
            return $this->valueHolder2861d->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder2861d;
    ...
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;
    ...
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, '__isset', array('name' => $name), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;
    ...
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, '__unset', array('name' => $name), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;
    ...
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, '__clone', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        $this->valueHolder2861d = clone $this->valueHolder2861d;
    }

    public function __sleep()
    {
        $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, '__sleep', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;

        return array('valueHolder2861d');
    }
    ...
    {
        $this->initializerea52e = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerea52e;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerea52e && ($this->initializerea52e->__invoke($valueHolder2861d, $this, 'initializeProxy', array(), $this->initializerea52e) || 1) && $this->valueHolder2861d = $valueHolder2861d;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder2861d;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder2861d;
    }
